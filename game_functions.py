...
def check_events(ai_settings, screen, stats, sb, play_button, ship,
        aliens, bullets):
	""" Responds to the keypresses and mouse events """
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets,
		play_button):
	''' Update image on screen and flip on the new screen '''
...
def check_aliens_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets):
	"""Check if any aliens have reached the bottom of thr screen"""
	screen_rect = screen.get_rect()
	for alien in aliens.sprites():
		if alien.rect.bottom >= screen_rect.bottom:
			# Treat this as same as the ship got hit.
...
def check_high_score(stats, sb):
	"""Check to see if there is a new high scores"""
